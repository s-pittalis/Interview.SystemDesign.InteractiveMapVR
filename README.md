...
Il backend è stato progettato per essere interamente containerizzato.  La struttura e l'organizzazione delle API del backend sono documentate in dettaglio nella [specifica OpenAPI](https://s-pittalis.github.io/Interview.SystemDesign.InteractiveMapVR/v3.html), consultabile in formato navigabile.
